...
import com.example.administrator.pingtai.net.GetCode;
import com.example.administrator.pingtai.net.SignUp;
import com.example.administrator.pingtai.net.UploadUtil;
import com.example.administrator.pingtai.tools.BitmapUtils;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(infoIsNotEmpty()) {
                    new SignUp(etVerificationCode.getText().toString(), etPhoneNum.getText().toString(),
                            new SignUp.SuccessCallback() {
                                ...
                                public void onSuccess() {
                                    ...
                                    final File files = new File(file,"icon.png");
                                    final UploadUtil uploadUtil = new UploadUtil();
                                    new Thread(new Runnable(){
                                        @Override
                                        public void run() {
                                            uploadUtil.uploadFile(files, PingTai_Config.SERVER_URL+"upload");
                                        }
                                    }).start();
