...
public class Login {
    public Login(String phoneNum, String password,final SuccessCallback successCallback,final FailCallback failCallback) {
        new NetConnection(PingTai_Config.SERVER_URL+"login", HttpMethod.POST, new NetConnection.SuccessCallback() {
            @Override
        ...
        }, PingTai_Config.KEY_ACTION,PingTai_Config.ACTION_LOGIN,PingTai_Config.KEY_PHONE_MD5,phoneNum,PingTai_Config.KEY_PASSWORD,password);
    }
